...
- 生命周期钩子：before*model_resolve、before_prompt_build、before_agent_start、llm_input、llm_output、agent_end、before_compaction、after_compaction、before_reset、message*\_、tool\__、before*message_write、session*_、subagent\_\_、gateway\_\*。
- 执行策略：
