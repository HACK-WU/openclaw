...
import {
  ...
  type SessionsTitleParams,
  SessionsTitleParamsSchema,
  type SessionsTitleResult,
  SessionsTitleResultSchema,
  type ShutdownEvent,
  ShutdownEventSchema,
...
export const validateSessionsTitleParams =
  ajv.compile<SessionsTitleParams>(SessionsTitleParamsSchema);
