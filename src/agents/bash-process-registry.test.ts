...
describe("bash process registry", () => {
  ...
  it("captures output and truncates", async () => {
  ...
  it("caps pending output to avoid runaway polls", async () => {
    const session: ProcessSession = {
      id: "sess",
      command: "echo test",
      child: { pid: 123 } as ChildProcessWithoutNullStreams,
  ...
  it("respects max output cap when pending cap is larger", async () => {
    const session: ProcessSession = {
      id: "sess",
      command: "echo test",
      child: { pid: 123 } as ChildProcessWithoutNullStreams,
  ...
  it("caps stdout and stderr independently in pending buffers", async () => {
    const session: ProcessSession = {
      id: "sess",
      command: "echo test",
      child: { pid: 123 } as ChildProcessWithoutNullStreams,
