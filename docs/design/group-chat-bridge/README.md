...
| 文档                                     | 内容                                                |
| ---------------------------------------- | --------------------------------------------------- |
| [架构分析](./architecture.md)            | 当前架构分析、可行性评估、Agent 类型扩展            |
| [TUI 渲染流程](./tui-rendering.md)       | PTY → xterm.js 五步保证、失败根因分析、终端尺寸同步 |
| [前端组件设计](./frontend-components.md) | 可折叠终端组件、双通道输出、完成检测策略            |
