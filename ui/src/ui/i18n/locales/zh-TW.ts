...
export const zhTW: Record<string, string> = {
  ...
  "chat.group.removeMember": "移除成員",
  "chat.group.removeMemberConfirm": "確定要移除成員 {name} 嗎？",
  "chat.group.add": "添加",
  "chat.group.noAvailableAgents": "沒有可添加的智能體。",
  "chat.group.noAnnouncement": "暫無公告",
  "chat.group.export": "匯出對話",
  "chat.group.maxRounds": "最大對話次數",
  "chat.group.maxRoundsHint": "單次群聊對話中智能體回覆的最大次數。",
  "chat.group.maxConsecutive": "最大連續回覆",
  "chat.group.maxConsecutiveHint": "單個智能體在讓出對話權之前可連續回覆的最大次數。",
  "chat.group.chainTimeout": "對話鏈超時",
  "chat.group.chainTimeoutHint": "從 Owner 發消息開始，對話鏈的最長持續時間。",
  "chat.group.cliTimeout": "CLI 執行超時",
  "chat.group.cliTimeoutHint": "單次 CLI 命令的最長執行時間。",
  "chat.group.timeoutSeconds": "秒",
  "chat.group.timeoutMinute": "分鐘",
  "chat.group.timeoutMinutes": "分鐘",
  ...
  // 專案管理
  "nav.projects": "專案",
  "nav.subtitle.projects": "管理專案目錄和相關文檔。",
  "project.title": "專案管理",
  "project.newProject": "新建專案",
  "project.list.empty.title": "暫無專案",
  "project.list.empty.description": "建立專案來統一管理你的程式碼目錄和相關文檔",
  "project.list.empty.button": "建立第一個專案",
  "project.card.directory": "專案目錄",
  "project.card.docs": "專案文檔",
  "project.card.groups": "關聯群聊",
  "project.card.manage": "管理",
  "project.card.edit": "編輯",
  "project.card.delete": "刪除",
  "project.card.createdAt": "建立於",
  "project.card.updatedAt": "最後更新",
  "project.total.count": "共 {count} 個專案",
  "project.dialog.create.title": "新建專案",
  "project.dialog.edit.title": "編輯專案 - {name}",
  "project.dialog.name.label": "專案名稱",
  "project.dialog.name.hint": "用於標識專案，建立後不可更改",
  "project.dialog.name.placeholder": "輸入專案名稱...",
  "project.dialog.name.required": "專案名稱為必填項",
  "project.dialog.name.exists": "專案名稱已存在",
  "project.dialog.directory.label": "專案目錄",
  "project.dialog.directory.hint": "CLI 智能體將在此目錄下工作",
  "project.dialog.directory.placeholder": "/path/to/your/project",
  "project.dialog.directory.required": "專案目錄為必填項",
  "project.dialog.directory.notFound": "目錄不存在",
  "project.dialog.docs.label": "專案文檔",
  "project.dialog.docs.hint": "注入到智能體上下文的檔案路徑，逗號分隔",
  "project.dialog.docs.placeholder": "README.md, docs/api.md",
  "project.dialog.docs.add": "添加文檔",
  "project.dialog.docs.remove": "移除",
  "project.dialog.docs.fileNotFound": "檔案不存在",
  "project.dialog.docs.count": "已選擇 {count} 個文檔",
  "project.dialog.description.label": "描述",
  "project.dialog.description.hint": "幫助你和團隊成員理解專案用途",
  "project.dialog.description.placeholder": "這是一個用於...的專案",
  "project.dialog.cancel": "取消",
  "project.dialog.create": "建立專案",
  "project.dialog.save": "保存修改",
  "project.delete.title": "刪除專案",
  "project.delete.confirm": '確定要刪除專案 "{name}" 嗎？此操作不可撤銷。',
  "project.delete.warning.groups": "此專案關聯了 {count} 個群聊，刪除後這些群聊將變為獨立群聊。",
  "project.delete.cancel": "取消",
  "project.delete.confirmButton": "確認刪除",

  // 專案規則管理
  "project.rules.title": "專案規則",
  "project.rules.create": "建立規則",
  "project.rules.edit": "編輯",
  "project.rules.delete": "刪除",
  "project.rules.empty.title": "暫無專案規則",
  "project.rules.empty.description": "建立規則來規範 Agent 的行為，規則將注入到關聯群聊的上下文中",
  "project.rules.empty.button": "建立第一條規則",
  "project.rules.dialog.create.title": "建立規則",
  "project.rules.dialog.edit.title": "編輯規則",
  "project.rules.dialog.title.label": "規則標題",
  "project.rules.dialog.title.hint": "為規則命名，便於識別和管理",
  "project.rules.dialog.title.placeholder": "輸入規則標題...",
  "project.rules.dialog.title.required": "規則標題為必填項",
  "project.rules.dialog.content.label": "規則內容",
  "project.rules.dialog.content.hint": "支援 Markdown 格式，將注入到關聯群聊的 Agent 上下文中",
  "project.rules.dialog.content.placeholder": "## 規則標題\n\n規則內容...",
  "project.rules.dialog.content.required": "規則內容為必填項",
  "project.rules.dialog.tab.edit": "編輯",
  "project.rules.dialog.tab.preview": "預覽",
  "project.rules.dialog.cancel": "取消",
  "project.rules.dialog.create": "建立規則",
  "project.rules.dialog.save": "保存修改",
  "project.rules.delete.title": "刪除規則",
  "project.rules.delete.confirm": '確定要刪除規則 "{title}" 嗎？此操作不可撤銷。',
  "project.rules.delete.hint": "刪除後，關聯群聊的 Agent 將不再收到此規則的上下文注入。",
