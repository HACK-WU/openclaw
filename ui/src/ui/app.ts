...
export class OpenClawApp extends LitElement {
  ...
  @state() chatStreamSegments: Array<{ text: string; ts: number }> | null = [];
  ...
  @state() groupStreams: Map<string, import("./controllers/group-chat.js").GroupStreamEntry> =
    new Map();
  ...
  @state() groupToolMessages: Map<
    string,
    import("./controllers/group-chat.js").GroupToolMessage[]
  > = new Map();
  ...
  @state() memoryStatus: import("./controllers/group-chat.js").GroupChatState["memoryStatus"] =
    null;
  @state()
  ...
  @state() projectSkills: ProjectSkill[] = [];
  @state() projectSkillsLoading = false;
  ...
  @state() sessionsGeneratingTitle: Set<string> = new Set();
  ...
  @state() skillFileEditing: string | null = null;
