      ...
      <div class="group-info-panel__settings">
        ${
          ...
          `
            ...
            <div class="group-info-panel__setting-item">
              <div class="group-info-panel__setting-header">
                <span class="group-info-panel__setting-name">${t("chat.group.announcementInterval")}</span>
                <div style="display: flex; align-items: center; gap: 6px;">
                  <input
                    type="number"
                    class="field group-info-panel__setting-input"
                    style="width: 60px;"
                    .value=${String(meta.contextConfig?.announcementInterval ?? 7)}
                    min="1"
                    max="50"
                    @change=${(e: Event) => {
                      const value = parseInt((e.target as HTMLInputElement).value, 10);
